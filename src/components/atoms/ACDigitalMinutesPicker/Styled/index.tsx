...
type ACCalendarStepProps = StyledComponentProps<
  "div",
  any,
  {
    selected: boolean;
...
export const ACCalendarTimeStep = styled.div<ACCalendarStepProps>`
  width: 100%;
  cursor: pointer;
  display: flex;
  ...
  background-color: ${(props) => {
    if (props.selected && props.color) return props.color;
