...
const ACPaginationItem: FC<ACPaginationItemProps> = ({
  ...
  return (
    <li
      ...
      className={`AC-PaginationItem AC-PaginationItem-size-${size} AC-PaginationItem-shape-${shape} ${paginationItemClass} ${
        selectedPage === num
          ? `AC-PaginationItem-selected-${color}-${variant} ${paginationItemActiveClass}`
          : ""
      }`}
...
const ACPagination = ({
  ...
  return (
    <ul style={stylePaginationWrapper} className={`AC-Pagination`}>
      {showControls && (
        <>
          <li
            data-testid="controlFirst"
            className={`AC-Pagination-controlIcon AC-PaginationItem-size-${size} AC-PaginationItem-shape-${shape} ${
      ...
      {pagesNums.map((num) => (
        <Fragment key={num}>
          ...
          {(num === 0 || num === -1) && (
            <li className="AC-Pagination-threeDots">
